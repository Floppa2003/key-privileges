...
Промо-баллы могут быть использованы для оплаты Подписки на РБК участниками с суммой от 6 000 000 рублей.
...
Правила программы лояльности
Редакция № 100
Редакция № 100 Правил введена в действие с 03.04.2026
