...
F={
 ...
 'rgo_detail.html':'<h1>Гостиница Паддок</h1><div class="section-text-2col">Скидка 10% на бронирование номера + 10 минут проката картинга в подарок. Предъявите членский билет.</div>',
