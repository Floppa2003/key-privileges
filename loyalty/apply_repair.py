"""Temporary code transfer; fail closed on baseline or tested-byte mismatch."""
...
subprocess.run(['git','apply','--recount','--check','loyalty/repair.patch'],check=True)
subprocess.run(['git','apply','--recount','loyalty/repair.patch'],check=True)
