...
STOP = {'http', 'https', 'промокод', 'промокоды', 'акция', 'скидка', 'скидки', 'мир', 'синий', 'серебряный', 'золотой', 'получите', 'дополнительные'} | set(('в во на для по при с со из от до после перед к и или либо не нет '
